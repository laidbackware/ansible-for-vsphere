...
class VmwareNamespaceClusterVdsManage(VmwareRestClient):
    ...
    def process_state(self):
        ...
        namespace_cluster_states[self.desired_state][self.check_namespace_cluster_status()]()

    def check_namespace_cluster_status(self):
        """
    ...
    def state_enable_cluster(self):
        ...
        vsphere_cluster_identifier = get_cluster_by_name(self.cluster_name)
        ...
        self.cluster_object.enable(vsphere_cluster_identifier, cluster_spec)

        error_count = 0
        while True:
            my_cluster = self.cluster_object.get(vsphere_cluster_identifier)
            print(my_cluster.config_status)
